...
alex = User.new( { first_name: "Alex", last_name: "Minior", password: "azertyuiop", email: "alex@commusub.com", country: 'France', bio: "My name is Alex and I'm a big fan of cinema. I love Game of Thrones!"  } )
...
fred = User.new( { first_name: "Fred", last_name: "Smith", password: "azertyuiop", email: "fred@commusub.com", country: 'France', bio: "My name is Frederic and I'm a big fan of Game of Thrones!" } )
...
amina = User.new( { first_name: "Amina", last_name: "Max", password: "azertyuiop", email: "amina@commusub.com", country: 'France', bio: "My name is Amina and I love watching sports like soccer or tennis. I'm a very competitive person." } )
...
sofia = User.new( { first_name: "Sofia", last_name: "Smith", password: "azertyuiop", email: "sofia@commusub.com", country: 'France', bio: "Hi! I'm Sofia and I love pop-music like everybody esle. I'm not a very unique person." } )
...
patricia = User.new( { first_name: "Patricia", last_name: "FLCL", password: "azertyuiop", email: "patricia@commusub.com", country: 'France', bio: "My name is Patricia and I love movie about love and romance. My favorite actor is Brad Pitt <3." } )
...
octave = User.new( { first_name: "Octave", last_name: "Collombel", password: "azertyuiop", email: "octave@commusub.com", country: 'France', bio: "My name is Octave and I watch love complicated movies like Christopher Nolan's movies." } )
...
corentin = User.new( { first_name: "Corentin", last_name: "Mirabeau", password: "azertyuiop", email: "corentin@commusub.com", country: 'France', bio: "My name is Corentin and I love documentaries about animals like bears or fish. I spend all my sunday watching that." } )
...
michel = User.new( { first_name: "Michel", last_name: "Smith", password: "azertyuiop", email: "michel@commusub.com", country: 'France', bio: "" } )
michel.save!
